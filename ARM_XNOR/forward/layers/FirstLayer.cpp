...
T* FirstLayer_::forward(T *input){
	...
	for(k = 0; k < nFilters; k++){
		...
		for(i = x0; i < input->X-x0; i += input->X - x0 - dX){
			...
			for(j = y0; j < input->Y-y0; j += input->Y - y0 - dY){
	...
	#ifdef TestFix16
							sum += ((int32_t)filter[aa+kk]*(int32_t)input->f[bb+kk])>>8;
	#elif defined(TestFix32)
							sum += ((int64_t)filter[aa+kk]*(int64_t)input->f[bb+kk])>>20;
	#else
				...
				// Batch Normalization 1
				sum = sum + bias[k];
				sum = (((((sum - mean1[k])*std1[k])>>20)*gamma1[k])>>20)+beta1[k];
				sum = max(0.0, sum);
				sum = (((((sum - mean2[k])*std2[k])>>20)*gamma2[k])>>20)+beta2[k];
	#else
				// Batch Normalization 1
				sum = sum + bias[k];
	...
	#ifdef TestFix16
				sum +=         (((int32_t) filter[ 0]*(int32_t)input->f[  leftX   *input->Y+leftY         ])>>8)+
						(((int32_t)filter[ 1]*(int32_t)input->f[  leftX   *input->Y+leftY + 1     ])>>8)+
						(((int32_t)filter[ 2]*(int32_t)input->f[  leftX   *input->Y+leftY + 2     ])>>8)+
						(((int32_t)filter[ 3]*(int32_t)input->f[ (leftX+1)*input->Y+leftY         ])>>8)+
						(((int32_t)filter[ 4]*(int32_t)input->f[ (leftX+1)*input->Y+leftY + 1     ])>>8)+
						(((int32_t)filter[ 5]*(int32_t)input->f[ (leftX+1)*input->Y+leftY + 2     ])>>8)+
						(((int32_t)filter[ 6]*(int32_t)input->f[ (leftX+2)*input->Y+leftY         ])>>8)+
						(((int32_t)filter[ 7]*(int32_t)input->f[ (leftX+2)*input->Y+leftY + 1     ])>>8)+
						(((int32_t)filter[ 8]*(int32_t)input->f[ (leftX+2)*input->Y+leftY + 2     ])>>8);
	#elif defined(TestFix32)
				sum +=         (((int64_t) filter[ 0]*(int64_t)input->f[  leftX   *input->Y+leftY         ])>>20)+
						(((int64_t)filter[ 1]*(int64_t)input->f[  leftX   *input->Y+leftY + 1     ])>>20)+
						(((int64_t)filter[ 2]*(int64_t)input->f[  leftX   *input->Y+leftY + 2     ])>>20)+
						(((int64_t)filter[ 3]*(int64_t)input->f[ (leftX+1)*input->Y+leftY         ])>>20)+
						(((int64_t)filter[ 4]*(int64_t)input->f[ (leftX+1)*input->Y+leftY + 1     ])>>20)+
						(((int64_t)filter[ 5]*(int64_t)input->f[ (leftX+1)*input->Y+leftY + 2     ])>>20)+
						(((int64_t)filter[ 6]*(int64_t)input->f[ (leftX+2)*input->Y+leftY         ])>>20)+
						(((int64_t)filter[ 7]*(int64_t)input->f[ (leftX+2)*input->Y+leftY + 1     ])>>20)+
						(((int64_t)filter[ 8]*(int64_t)input->f[ (leftX+2)*input->Y+leftY + 2     ])>>20);
	#else
