...
with open('mypopcount_MFCC_wave16bit_Q20model_intinput_250MHz.csv','r') as csvfile:
...
plt.xlim(-0.82-starttime, -0.13 -starttime)
...
p = plt.axvspan(0, 0+0.00469724, facecolor='blue', alpha=0.6)
p = plt.axvspan(0+0.00469724, 0+0.0154336, facecolor='green', alpha=0.6)
p = plt.axvspan(0+0.0154336, 0+0.0399841, facecolor='gray', alpha=0.6)
p = plt.axvspan(0+0.0399841, 0+0.0500495, facecolor='red', alpha=0.6)
