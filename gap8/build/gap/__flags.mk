...
PULP_LDFLAGS_api = /home/msc18f9/Documents/pulp-sdk/pkg/sdk/dev/install/lib/gap/crt0.o -nostartfiles -nostdlib -Wl,--gc-sections -T/scratch/sem17f11/xnornet_gap8/gap8/build/gap/api.ld -L/home/msc18f9/Documents/pulp-sdk/pkg/sdk/dev/install/lib/gap -lrt -lrtio -lrt -lgcc
PULP_OMP_LDFLAGS_api = -lgomp
pulpRunOpt        += --platform=gvsoc --dir=/scratch/sem17f11/xnornet_gap8/gap8/build/gap --config-file=/scratch/sem17f11/xnornet_gap8/gap8/build/gap/config.json --pdb-no-break --load-binary=api/api:-1 --boot-binary=/home/msc18f9/Documents/pulp-sdk/pkg/sdk/dev/install/bin/boot-gap
pulpRunOpt        += $(PLT_OPT)
