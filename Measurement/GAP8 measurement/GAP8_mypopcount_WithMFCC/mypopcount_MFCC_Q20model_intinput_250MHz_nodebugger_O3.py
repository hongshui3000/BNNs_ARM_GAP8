...
with open('mypopcount_MFCC_Q20model_intinput_250MHz_nodebugger_O3.csv','r') as csvfile:
...
plt.gcf().subplots_adjust(bottom=0.15,left=0.1,right=0.98)
plt.xlim(-0.4-starttime, 0.19 -starttime)
...
print("mfccf_total      I * V * s = " + str(mfccf1_current) + " * " + str(2.8) + " * " + str(0.00398649*580/48) + " = " + str(mfccf1_current*2.8*0.00398649*580/48))
