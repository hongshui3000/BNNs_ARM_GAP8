...
with open('mypopcount_BNNonly_Q20model_intinput_250MHz.csv','r') as csvfile:
...
plt.xlim(-2.5-starttime, -1.9 -starttime)
...
p = plt.axvspan(0, 0+0.0115036, facecolor='green', alpha=0.6)
p = plt.axvspan(0+0.0115036, 0+0.035621, facecolor='gray', alpha=0.6)
p = plt.axvspan(0+0.035621, 0+0.0456613, facecolor='red', alpha=0.6)
