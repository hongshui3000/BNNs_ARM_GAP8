...
with open('MFCC_singlecore_intinput_nounrolling.csv','r') as csvfile:
    ...
    for row in plots:
        if header == 0:
            ...
            if float(row[0]) < starttime+0.0231 and float(row[0]) > starttime:
...
plt.xlim(3.5-starttime, 8.5 -starttime)
