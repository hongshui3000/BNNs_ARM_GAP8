...
extern void dma_transfer_ext2loc(uint32_t* l2_base_address, uint32_t* l2_offset, uint32_t* l1_address, uint32_t size, uint8_t element_size);
 ...
 */
extern void myPrintf( double fVal, int class_index);
