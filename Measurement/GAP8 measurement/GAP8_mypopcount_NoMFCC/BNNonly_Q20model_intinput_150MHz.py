...
with open('BNNonly_Q20model_intinput_150MHz.csv','r') as csvfile:
...
plt.xlim(-0.95-starttime, 0.017-starttime) #250M
...
# = plt.axvspan(0, 0+0.005469, facecolor='green', alpha=0.6)
