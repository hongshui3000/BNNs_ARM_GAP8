...
header = 0
starttime = 0.3027
endtime = 0.3027+0.4996
#with open('All_period_MFCC_BNNs_32000_points.csv','r') as csvfile:
with open('BNNonly_Q20model_intinput_250MHz.csv','r') as csvfile:
...
plt.xlim(0.29-starttime, 0.81-starttime) #250M, show all tiles
#plt.xlim(0.29-starttime, 0.365-starttime) #250M, show first tile
plt.ylim(20, 60)  #250M
plt.xticks(fontsize=16)
plt.yticks(fontsize=16)
plt.xlabel('time (s)',fontsize=16)
p = plt.axvspan(0, 0+0.0114285, facecolor='green', alpha=0.6) #first layer shorter than Q20 because of int input
p = plt.axvspan(0+0.0114285, 0+0.015427, facecolor='red', alpha=0.6)
p = plt.axvspan(0+0.015427, 0+0.0262735, facecolor='gray', alpha=0.6)
p = plt.axvspan(0+0.0262735, 0+0.0303322, facecolor='red', alpha=0.6)
p = plt.axvspan(0+0.0303322, 0+0.0344267, facecolor='gray', alpha=0.6)
p = plt.axvspan(0+0.0344267, 0+0.0442435, facecolor='red', alpha=0.6)
