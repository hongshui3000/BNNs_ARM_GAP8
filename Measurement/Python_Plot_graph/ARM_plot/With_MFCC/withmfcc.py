...
p = plt.axvspan(-3.86+3.86, -3.767+3.86, facecolor='blue', alpha=0.6)
p = plt.axvspan(-3.767+3.86, -3.561+3.86, facecolor='green', alpha=0.6)
p = plt.axvspan(-3.561+3.86, -2.190+3.86, facecolor='gray', alpha=0.6)
#p = plt.axvspan(-3.561+3.86, -3.384+3.86, facecolor='gray', alpha=0.6)
#p = plt.axvspan(-3.384+3.86, -2.760+3.86, facecolor='gray', alpha=0.6)
#p = plt.axvspan(-2.760+3.86, -2.490+3.86, facecolor='gray', alpha=0.6)
#p = plt.axvspan(-2.490+3.86, -2.190+3.86, facecolor='gray', alpha=0.6)
p = plt.axvspan(-2.190+3.86, -2.046+3.86, facecolor='red', alpha=0.6)
