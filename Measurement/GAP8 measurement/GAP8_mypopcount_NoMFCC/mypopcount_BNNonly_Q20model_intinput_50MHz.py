...
with open('mypopcount_BNNonly_Q20model_intinput_50MHz.csv','r') as csvfile:
...
plt.xlim(-2.4-starttime, 0.893-starttime)
...
p = plt.axvspan(0+0.005469, 0+0.0696419, facecolor='gray', alpha=0.6)
p = plt.axvspan(0+0.0696419, 0+0.0992451, facecolor='red', alpha=0.6)
p = plt.axvspan(0+0.0992451, 0+0.171138, facecolor='gray', alpha=0.6)
p = plt.axvspan(0+0.171138, 0+0.196062, facecolor='red', alpha=0.6)
p = plt.axvspan(0+0.196062, 0+0.221786, facecolor='gray', alpha=0.6)
p = plt.axvspan(0+0.221786, 0+0.283739, facecolor='red', alpha=0.6)
